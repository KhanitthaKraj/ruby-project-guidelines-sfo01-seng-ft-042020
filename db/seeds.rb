...
q3 = Question.create(question: "4 + 3", answer: "7", hint: "Hint: Use near by objects to help count!")
q4 = Question.create(question: "4 - 4", answer: "0", hint: "Hint: You have 4 apples, you share all of them to your mom, how many do you have left?")
q5 = Question.create(question: "7 - 5", answer: "2", hint: "Hint: Use your fingers to help count!")
q6 = Question.create(question: "10 - 2", answer: "8", hint: "Hint: All fingers come up and count! How many fingers do you have? Now put down 2 of them and count again!")
q7 = Question.create(question: "3 - 2", answer: "1", hint: "Hint: Use your favorite toys to help count!")
q8 = Question.create(question: "1 + 2", answer: "3", hint: "Hint: You have 1 ball, and mom gives you 2 more!")
q9 = Question.create(question: "3 + 1", answer: "4", hint: "Hint: You have 3 balls, and friend gives you 1 more!")
q10 = Question.create(question: "1 2 3 4 5 6 ? What number comes after 6?", answer: "7", hint: "Hint: Set a paper and a pen, write all numbers from 1 to 10")
q11 = Question.create(question: "1 2 3 ? what number comes after 3?", answer: "4", hint: "Hint: Set a paper and a pen, write all numbers from 1 to 10")
